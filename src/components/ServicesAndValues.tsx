...
const servicesData: Record<string, ServiceDetail> = {
  maintenance: {
    ...
    desc: "Nous assurons la maintenance complète de vos systèmes informatiques avec un support technique réactif et professionnel pour garantir la continuité de vos activités.",
    offres: [
      ...
      "Réparation et diagnostic matériel avancé",
    ],
    tech: [
      "Diagnostic avancé",
  ...
  label: "Cybersécurité",
  icon: "ti-shield-lock",
  title: "Cybersécurité, SOC & Administration Systèmes",
  desc: "Nous assurons la protection, la supervision et l'administration complète de vos infrastructures informatiques afin de garantir la sécurité, la disponibilité et la performance de vos systèmes.",
  offres: [
    "Surveillance continue des systèmes et réseaux (SOC)",
    "Administration et gestion des systèmes Linux & Windows",
    "Analyse des incidents et réponse rapide aux menaces",
    "Sécurisation des infrastructures et des accès",
  ],
  tech: [
    "Supervision des événements de sécurité",
    "Gestion des systèmes et serveurs",
  ...
  ia: {
    ...
    desc: "Intégration de solutions intelligentes pour automatiser, analyser et optimiser vos processus métiers.",
    offres: [
  ...
  infrastructure: {
    ...
    desc: "Conception, déploiement et gestion d’infrastructures informatiques robustes, sécurisées et évolutives.",
    offres: [
      "Architecture d’infrastructure moderne",
